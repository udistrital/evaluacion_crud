...
// @Param	body		body 	models.ResultadoEvaluacion	true		"body for ResultadoEvaluacion content"
// @Success 201 {int} models.ResultadoEvaluacion
...
// @Success 200 {object} models.ResultadoEvaluacion
// @Failure 404 not found resource
// @router /:id [get]
func (c *ResultadoEvaluacionController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetResultadoEvaluacionById(id)
	if err != nil {
		logs.Error(err)
		//c.Data["development"] = map[string]interface{}{"Code": "000", "Body": err.Error(), "Type": "error"}
		c.Data["system"] = err
...
// @Failure 404 not found resource
// @router / [get]
func (c *ResultadoEvaluacionController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllResultadoEvaluacion(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
		//c.Data["development"] = map[string]interface{}{"Code": "000", "Body": err.Error(), "Type": "error"}
		c.Data["system"] = err
...
// @Failure 400 the request contains incorrect syntax
// @router /:id [put]
func (c *ResultadoEvaluacionController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
...
// @Failure 404 not found resource
// @router /:id [delete]
func (c *ResultadoEvaluacionController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteResultadoEvaluacion(id); err == nil {
